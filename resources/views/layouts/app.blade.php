...
<body>
    <nav class="flex sticky top-0 bg-orange-500 p-5 justify-around">
        <a class="font-serif text-xl" href="#">Restaurant POS</a>
            <ul class="font-sans font-semibold flex gap-8  ">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                    ...
                    <a href="{{ route('orders.create') }}">Admin</a>
                </li>
                <li class="inline-flex hover:underline decoration-2 underline-offset-4"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
